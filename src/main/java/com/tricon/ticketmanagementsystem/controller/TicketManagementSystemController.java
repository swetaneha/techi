...
//	private ITicketManagementSystemService ticketManagementSystem;
	...
	@RequestMapping(value="/liststatus",params = { "page", "total"},method=RequestMethod.GET)   
	  	public List<Status> getStatus(@RequestParam( "page" ) int page, @RequestParam( "total" ) int total) { 
	  		System.out.println("Inside: Controller");
	  		if(page!=1) {
	  			page=((page-1)*total)+1;
	  		}
	  		return ticketManagementSystem.getStatus(page,total); 
	 	} 
	...
	public int countStatus()
	{
		...
		return ticketManagementSystem.getCount();
	}
	...
	public ResponseEntity<String> updateTicket(@RequestBody Ticket ticket) {
		System.out.println("Inside: Controller");
		String responseStatus=ticketManagementSystem.updateTicket(ticket);
		if(responseStatus=="SUCCESS")
		    return new ResponseEntity<String>("{\"success\":\"true\"}", HttpStatus.OK);
		else
		{
    ...
    public List<Priority> getPriority() {  
    	System.out.println("Inside: Controller");  
   		return ticketManagementSystem.getPriority();  
   	} 
	...
	@RequestMapping(value="/liststatuswithoutpagination",method=RequestMethod.GET)   
	  public List<Status> getStatus() { 
	  System.out.println("Inside: Controller"); 
	  return ticketManagementSystem.getStatusWithOutPagination(); 
	} 
